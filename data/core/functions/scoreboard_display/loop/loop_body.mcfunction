...
$scoreboard players operation $(team) game_team_score += $(team) game_store_score
...
execute store result storage mcmmt:core scoreboard.content.finish_room int 1 run scoreboard players get all game_finish_room
$execute store result storage mcmmt:core scoreboard.content.score int 1 run scoreboard players get $(team) game_team_score
...
execute unless data storage mcmmt:core scoreboard.content.finish_count run data modify storage mcmmt:core scoreboard.content.finish_count set value 0
