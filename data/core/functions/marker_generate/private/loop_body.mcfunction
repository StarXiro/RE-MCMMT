...
$kill @e[name="$(displayname)",type=marker,tag=generated]
$summon marker 0 $(index) 0 {CustomName:'{"type":"text","text":"$(displayname)","color":"$(color)"}',Tags:["generated"]}
...
$data modify entity @e[name="$(displayname)",type=marker,limit=1] data.woolcolor set value "$(woolcolor)"