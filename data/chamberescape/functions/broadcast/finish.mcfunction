...
$execute if score $(color) room$(num) matches 2 run tellraw @a[tag=Chamber_escape,team=$(color)] {"translate":"%s 你们队伍第%s个完成了房间%s。","with":[{"text":"[+32 pts]","color":"gold"},{"text":"2","color":"#c0c0c0"},{"text":"$(num)","color":"aqua"}]}
$execute if score $(color) room$(num) matches 3 run tellraw @a[tag=Chamber_escape,team=$(color)] {"translate":"%s 你们队伍第%s个完成了房间%s。","with":[{"text":"[+16 pts]","color":"gold"},{"text":"3","color":"#b87333"},{"text":"$(num)","color":"aqua"}]}
